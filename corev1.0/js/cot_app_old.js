...
cot_app.prototype.render = function(fCallback) {
	...
	if (this.includeFormValidation) {$("#appCode").append('<link rel="stylesheet" href="../corev1.0/css/bootstrapValidator.min.css"><script type="text/javascript" src="../corev1.0/js/cot_forms.js"><script type="text/javascript" src="../corev1.0/js/bootstrapValidator.min.js"></script>');}
	...
	if (this.includeDatePicker) {$("#appCode").append('<link rel="stylesheet" href="../corev1.0/js/bootstrap-datetimepicker.css"><script type="text/javascript" src="../corev1.0/js/moment-with-locales.js"></script><script type="text/javascript" src="../corev1.0/js/bootstrap-datetimepicker.js"></script>');}
	var app=this;
